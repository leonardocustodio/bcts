...
| [**crypto**](packages/crypto) | Cryptographic primitives including symmetric encryption, hashing, and key derivation (HKDF, PBKDF2). [📖 Docs](https://docs.bcts.dev/api/crypto) \| [🦀 Rust](https://github.com/BlockchainCommons/bc-crypto-rust) |
